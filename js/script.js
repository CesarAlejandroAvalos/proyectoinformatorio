...
function showResult(){
    ...
    if (userScore > 7){ // if user scored more than 3
        ...
        let scoreTag = '<span>Y felicitaciones! 🎉, Obtuviste <p>'+ userScore +'</p> de <p>'+ questions.length +'</p></span>';
        ...
        let scoreTag = '<span>Lastima😐, Solo obtuviste <p>'+ userScore +'</p> de <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
